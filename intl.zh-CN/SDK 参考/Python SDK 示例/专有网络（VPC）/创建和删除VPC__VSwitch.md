...
4.  使用编辑器打开vpc\_quick\_start.py文件，根据实际情况配置相关参数，保存退出。 
    ...
    class VpcQuickStart(object):
        ...
        def create_vpc(self):
            """
            create_vpc：创建VPC
            官网API参考链接:https://www.alibabacloud.com/help/doc-detail/35737.htm
            """
            try:
        ...
        def delete_vpc(self, params):
            """
            delete_vpc: 删除VPC
            官网API参考链接: https://www.alibabacloud.com/help/doc-detail/35738.htm
            """
            try:
        ...
        def describe_vpc_attribute(self, vpc_id):
            ...
            官网API参考: https://www.alibabacloud.com/help/doc-detail/94565.htm
            """
            try:
        ...
        def create_vswitch(self, params):
            ...
            官网API参考: https://www.alibabacloud.com/help/doc-detail/35745.htm
            """
            try:
        ...
        def describe_vswitch_attribute(self, vswitch_id):
            ...
            官网API参考: https://www.alibabacloud.com/help/doc-detail/94567.htm
            """
            try:
        ...
        def delete_vswitch(self, params):
            ...
            官网API参考: https://www.alibabacloud.com/help/doc-detail/35746.htm
            """
            try:
